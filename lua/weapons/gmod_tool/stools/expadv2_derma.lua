...
if CLIENT then
	language.Add( "Tool.expadv2_derma.name", "Expression Advanced 2" )
	language.Add( "Tool.expadv2_derma.desc", "Creates an ingame scriptable entity." )
	language.Add( "Tool.expadv2_derma.help", "Place an Expression Advanced Gate or screen." )
	language.Add( "Tool.expadv2_derma.0", "Place an Expession Advanced Gate or screen." )
	language.Add( "Tool.expadv2_derma.1", "Pod selected. Right click an Expression advanced entity to link it." )
...
if WireLib then
	TOOL.Name						= "ExpAdv2 - Derma Screen"
...
local function MakeExpadvScreen( Player, Position, Angle, Model, InPorts, OutPorts )
	...
	local ExpAdv = ents.Create( "expadv_derma_screen" )
...
duplicator.RegisterEntityClass( "expadv_derma_screen", MakeExpadvScreen, "Pos", "Ang", "Model", "DupeInPorts", "DupeOutPorts" )
...
if CLIENT then
	...
	function TOOL.BuildCPanel( CPanel )
		...
		PropList:SetConVar( "expadv2_derma_model" )
		CPanel:AddItem( PropList )

		local Screen = CPanel:CheckBox( "Create screen", "expadv2_derma_screen" )
		local CheckWeld  = CPanel:CheckBox( "Create Welded", "expadv2_derma_weld" )
		local CheckFroze = CPanel:CheckBox( "Create Frozen", "expadv2_derma_frozen" )
		local CheckWorld = CPanel:CheckBox( "Create Welded to World", "expadv2_derma_weldworld" )
		...
		local function AddModel( Mdl, IsScreen )
			...
			Icon.DoClick = function( ) 			
				RunConsoleCommand( "expadv2_derma_screen", IsScreen and 1 or 0 )
				RunConsoleCommand( "expadv2_derma_model", Mdl )
