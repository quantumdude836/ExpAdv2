...
EXPADV.Syntaxer = EXPADV.Syntaxer or { First = true } 
local Syntaxer = EXPADV.Syntaxer 
...
hook.Add( "Expadv.PostLoadCore", "Expadv.Syntaxer", Syntaxer.Rebuild )
...
function EXPADV.Highlight( Editor, Row )
