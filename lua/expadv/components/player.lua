...
Component:AddEvent( "playerExitedVehicle", "ply,e", "" )
EXPADV.AddEventHelper( "playerExitedVehicle", "Called when a player exits a vehicle." )

Component:AddEvent( "playerEnteredVehicle", "ply,e,n", "" )
EXPADV.AddEventHelper( "playerEnteredVehicle", "Called when a player enters a vehicle the 3rd argument is the players role." )
...
if SERVER then
	...
	hook.Add( "PlayerLeaveVehicle", "Expav.Event", function( Player, Car )
		EXPADV.CallEvent( "playerExitedVehicle", Player, Car or Entity(0) )
	end )
	
	hook.Add( "PlayerEnteredVehicle", "Expav.Event", function( Player, Car, Role )
		EXPADV.CallEvent( "playerEnteredVehicle", Player, Car or Entity(0), Role or 0 )
	end )
end
